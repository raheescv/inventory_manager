                            ...
                            <div class="col-md-4">
                                ...
                                <div class="_dm-colorShcemesMode">
                                    ...
                                    <button type="button" class="_dm-colorModeBtn btn p-1 shadow-none"
                                        ...
                                        <img src="@/assets/img/color-schemes/expanded-header.png"
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="_dm-colorShcemesMode">
                                    ...
                                    <button type="button" class="_dm-colorModeBtn btn p-1 shadow-none"
                                        ...
                                        <img src="@/assets/img/color-schemes/fair-header.png"
                                            alt="color scheme illusttration" loading="lazy">
                                    </button>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="_dm-colorShcemesMode">
                                    ...
                                    <button type="button" class="_dm-colorModeBtn btn p-1 shadow-none"
                                        ...
                                        <img src="@/assets/img/color-schemes/full-header.png"
                                            alt="color scheme illusttration" loading="lazy">
                                    </button>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="_dm-colorShcemesMode">
                                    ...
                                    <button type="button" class="_dm-colorModeBtn btn p-1 shadow-none"
                                        ...
                                        <img src="@/assets/img/color-schemes/navigation.png"
                                            alt="color scheme illusttration" loading="lazy">
                                    </button>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="_dm-colorShcemesMode">
                                    ...
                                    <button type="button" class="_dm-colorModeBtn btn p-1 shadow-none"
                                        ...
                                        <img src="@/assets/img/color-schemes/tall-header.png"
                                            alt="color scheme illusttration" loading="lazy">
                                    </button>
